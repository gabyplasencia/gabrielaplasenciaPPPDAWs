...
const CapitalsTurbo = () => {
  ...
  <p>❌ Incorrect: {incorrectCount}</p>
                        ...
                        {options.map((country, index) => (
                            <div 
                              ...
                              onClick={() => !selectedAnswer && handleAnswer(country)}
                                style={{ height: '10rem', width: '16rem', backgroundImage: `url(${country.flag})`, backgroundSize: 'contain', backgroundPosition: 'top left', backgroundRepeat: 'no-repeat' }}
                            >
                               {/* <img 
                                src={country.flag} 
            ...
            <svg width="148" height="74" viewBox="0 0 148 74" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="mode__icon mode__icon-turbo">
